[![Build Status](https://travis-ci.org/sofiarocha/js-training.svg?branch=master)](https://travis-ci.org/sofiarocha/js-training)
## Setup
First, [**fork**](https://github.com/sofiarocha/js-training/fork?fragment=1) this repository.
